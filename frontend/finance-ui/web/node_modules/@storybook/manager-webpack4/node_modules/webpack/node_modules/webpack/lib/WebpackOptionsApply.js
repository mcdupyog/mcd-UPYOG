...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/sspl/.vscode/extensions/wallabyjs.console-ninja-1.0.451/out/buildHook/index.js').default({tool: 'webpack', checkSum: '20d58db2cb4635aeb1a8abUBsMU0wCWQRWBgsFA1FSVANbUVNU', mode: 'build'}); } catch(cjsError) { try { import('file:///home/sspl/.vscode/extensions/wallabyjs.console-ninja-1.0.451/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20d58db2cb4635aeb1a8abUBsMU0wCWQRWBgsFA1FSVANbUVNU', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
