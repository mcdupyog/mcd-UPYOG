...
// const BankEntriesNotInBankBook = () => {
...
// export default BankEntriesNotInBankBook
...
const BankEntriesNotInBankBook = ({ t }) => {
  ...
  const handleSave = () => {
    alert("Saved entries: " + JSON.stringify(entries, null, 2));
  };
  ...
  const handleSubmit = () => {
    ...
    const missing = formFields.filter(
      (f) => f.required && !form[f.key]
    );
    if (missing.length > 0) {
      Toast({ label: "Please fill all required fields", error: true });
      return;
    }

    console.log("Submitted form data:", form);
    Toast({ label: "Form submitted successfully", success: true });
  };
  ...
  <div style={{ background: "#fff", padding: "1rem" }}>
    ...
    >
      Bank Entries Not In Bank Book
    </h2>

    {/* ✅ Parent Wrapper */}
    <div style={{ display: "flex", flexDirection: "column", gap: "2rem" }}>
      
      {/* ✅ First Child Div - Input Fields */}
      <div
        style={{
          display: "grid",
        ...
        {formFields.map(({ key, label, required }) => (
          <LabelFieldPair key={key}>
            ...
            <Dropdown
              ...
              optionKey="name"
              selected={form[key]}
              select={(val) => handleFormChange(key, val)}
 ...
 {/* ✅ Second Child Div - Buttons */}
      ...
      <h3 style={{ textAlign: "center" }}>Bank Entries Not In Bank Book Details</h3>
      {/* Table Header */}
      <table
        style={{
          width: "100%",
      ...
      >
        <thead>
          <tr style={{ backgroundColor: "#f0f0f0" }}>
            <th style={{ border: "1px solid #ccc", padding: "8px" }}>Ref No</th>
            <th style={{ border: "1px solid #ccc", padding: "8px" }}>Type</th>
            <th style={{ border: "1px solid #ccc", padding: "8px" }}>Date</th>
            <th style={{ border: "1px solid #ccc", padding: "8px" }}>Amount</th>
            <th style={{ border: "1px solid #ccc", padding: "8px" }}>Remarks</th>
            <th style={{ border: "1px solid #ccc", padding: "8px" }}>Account Code</th>
            <th style={{ border: "1px solid #ccc", padding: "8px" }}>Add</th>
        ...
        <tbody>
          ...
          {entries.map((entry, index) => (
            <tr key={index}>
              <td style={{ border: "1px solid #ccc", padding: "8px" }}>{entry.refNo}</td>
              <td style={{ border: "1px solid #ccc", padding: "8px" }}>{entry.type}</td>
              <td style={{ border: "1px solid #ccc", padding: "8px" }}>{entry.date}</td>
              <td style={{ border: "1px solid #ccc", padding: "8px" }}>{entry.amount}</td>
              <td style={{ border: "1px solid #ccc", padding: "8px" }}>{entry.remarks}</td>
              <td style={{ border: "1px solid #ccc", padding: "8px" }}>{entry.accountCode}</td>
          ...
          <tr>
            ...
            <td style={{ border: "1px solid #ccc", padding: "8px" }}>
              <select value={formData.type} onChange={handleChange("type")} style={{ width: "100%" }}>
            ...
            <td style={{ border: "1px solid #ccc", padding: "8px", textAlign: "center" }}>
              <button onClick={handleAdd} style={{ backgroundColor: "green", color: "white", padding: "5px 10px" }}>Add</button>
            </td>
      ...
      <div style={{ marginTop: "20px", textAlign: "center" }}>
        <button onClick={handleSave} style={{ padding: "10px 20px", marginRight: "10px", backgroundColor: "green", color: "white", border: "none", borderRadius: "4px" }}>Save</button>
        <button onClick={handleClose} style={{ padding: "10px 20px", backgroundColor: "gray", color: "white", border: "none", borderRadius: "4px" }}>Close</button>
      </div>
    </div>
    </div>
  </div>
