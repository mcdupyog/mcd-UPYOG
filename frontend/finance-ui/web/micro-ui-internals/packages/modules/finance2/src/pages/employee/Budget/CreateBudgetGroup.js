...
const CreateBudgetGroup = () => {
  ...
  return (
    <React.Fragment>
      <Header className="works-header-search">{t("FINANCE_CREATE_BUDGET_GROUP")}</Header>
      <Card>
        <div style={{ marginBottom: "16px" }}>
          <div style={{ padding: "16px", marginTop: "8px" }}>
            ...
            {/* Account Type */}
            <LabelFieldPair>
              <CardLabel>{`${t("FINANCE_ACCOUNT_TYPE *")}`}</CardLabel>
              <div className="field">
                <Controller
                  control={control}
                  name={"accountType"}
            ...
            {/* Budgetting Type */}
            <LabelFieldPair>
              <CardLabel>{`${t("FINANCE_BUDGETTING_TYPE")}`}</CardLabel>
              <div className="field">
                <Controller
                  control={control}
                  name={"budgettingType"}
            ...
            {/* Major Code*/}
            <LabelFieldPair>
              <CardLabel>{`${t("FINANCE_USE_MAJOR_CODE")}`}</CardLabel>
              <div className="field" >
                <Controller
                  control={control}
                  name={"useMajorCode"}
                  ...
                  render={(props) => (
                    <RadioButtons
                      ...
                      onSelect={setSelectedRadioButton}
                      name="yesno"
            ...
            <div style={{ display: "flex", width: "1200px", justifyContent: "center", marginTop: "30px", marginBottom: "25px" }}>
              <span style={{ fontWeight: "bold" }}>OR</span>
            </div>

            {/* Detailed Min Code*/}
            <LabelFieldPair>
              <CardLabel>{`${t("FINANCE_DETAILED_MIN_CODE")}`}</CardLabel>
              <div className="field">
                <Controller
                  control={control}
            ...
            <LabelFieldPair>
              {" "}
              <CardLabel>{`${t("FINANCE_DETAILED_MAX_CODE")}`}</CardLabel>
              <div className="field">
                <Controller
                  control={control}
                  name={"detailedMaxCode"}
                  defaultValue={selectedDetailedMaxCode}
                  rules={{ required: t("CORE_COMMON_REQUIRED_ERRMSG") }}
                  render={(props) => (
                    <Dropdown
                      className="form-field"
                      selected={selectedDetailedMaxCode}
                      select={setSelectedDetailedMaxCode}
                      optionCardStyles={{ overflowY: "auto", maxHeight: "300px" }}
                      option={detailedMaxCodeOptions}
                      optionKey="i18nKey"
                      t={t}
                      placeholder={"Select"}
                    />
            ...
            {/* Budget Group Active*/}
            <LabelFieldPair>
              <CardLabel>{`${t("FINANCE_BUDGET_GROUP_ACTIVE")}`}</CardLabel>
              <div className="field">
                <CheckBox />
              </div>
            </LabelFieldPair>
      ...
      <div>
        ...
        <Card>
          <LabelFieldPair>
            <CardLabel>{t("FINANCE_CREATE_BUDGET_NAME")}</CardLabel>
            <div className="field">
              <Controller
                control={control}
                name="name"
                ...
                render={(props) => <TextInput value={selectedModifyName} style={{ marginTop: "20px", width: "400px" }} />}
              />
            </div>
          </LabelFieldPair>
          {/* Buttons */}
...
export default CreateBudgetGroup;
